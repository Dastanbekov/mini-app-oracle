    ...
    return (
        ...
        >
            <div className="relative group">
                ...
                <input required type="text" className="w-full bg-black/40 border border-gray-700 rounded-xl p-3 pl-10 text-white placeholder-gray-600 focus:outline-none focus:border-accent transition-colors appearance-none" placeholder="Ваше Имя" />
            </div>
            ...
            <div className="relative group">
                ...
                {/* Mobile-friendly date input: color-scheme dark fixes picker colors on iOS/Android */}
                <input
                    required
                    type="date"
            ...
            <div className="relative group">
                <Clock className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-accent transition-colors pointer-events-none" size={18} />
                <input
                    required
                    type="time"
                    className="w-full bg-black/40 border border-gray-700 rounded-xl p-3 pl-10 text-white focus:outline-none focus:border-accent transition-colors appearance-none min-h-[46px]"
            ...
            <div className="relative group">
                <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-accent transition-colors pointer-events-none" size={18} />
                <input required type="text" className="w-full bg-black/40 border border-gray-700 rounded-xl p-3 pl-10 text-white placeholder-gray-600 focus:outline-none focus:border-accent transition-colors appearance-none" placeholder="Место рождения" />
            </div>
